...
<div class="middle";>
 ...
 <form method="post" name="myform" action="pharm_reg.php"  onsubmit="return valueEmpty()">
 <h2><center> <marquee direction="right" style="background-color:"> Gamby General Hospital </marquee> </h2>   </center>  
<h2><center> <marquee direction="none" style="background-color:"> Pharmacists signup form </marquee> </h2>   </center>
