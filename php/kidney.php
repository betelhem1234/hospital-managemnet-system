...
<div class="middle";>
<p><h2>About Kidney Transplant</h2></p>
<br>
<p>Kidney Transplant is a procedure usually performed<br> on patients that have diseased, damaged, or non-functioning kidneys. In this procedure, the<br>patient is generally placed under general anesthesia. The doctor <br>will then make an incision in the abdominal area, and will insert <br>the donor kidney(s) into the patients body (without removing the patients old kidney). </p>
 </div>
<footer>
