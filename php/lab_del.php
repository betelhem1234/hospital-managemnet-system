...
$email = $_POST['email'];
	...
	if (!$connection) {
		...
		$sql = "select email_address from labratory where email_address = '$email'";
			...
			echo "</script>";}
			 ...
			 $sqldelete = "delete from labratory where email_address = '$email'";
