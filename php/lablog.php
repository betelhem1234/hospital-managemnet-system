...
<form method="post" name="myform" action="lab_log.php" onsubmit="return valueEmpty()">
<div class="in">EMAIL ADDRES:</div> <input type="email" name="email" class="input" id="email"/>
 <br>
<p></p>
 ...
 <br>
 <p></p>
   <input type="submit" name="submit" placeholder="log in" class="submit" value="log in" />
 <br>
