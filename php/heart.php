...
<div class="middle";>
<p>
<h2>general and specialty surgical services.</h2>

*Cardiothoracic CCU
*Electrophysiology
*Non-Invasive Cardiology
The Centres have dedicated Cardiothoracic CCUs with 1:1 nursing<br> 
ratio, round the clock. They are well equipped with bedside color<br> 
doppler, echocardiography system, continuous oxygen supply, infusion <br>
pumps, defibrillator, ventilators, invasive as well as non-invasive<br>
 pressure monitoring systems, temporary pace maker (transdermal as <br>
well as transvenous), intra aortic balloon pump, ABG (Blood Gas machine) and <br>S
