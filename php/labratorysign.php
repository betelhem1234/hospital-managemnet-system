...
<form method="post" name="myform" action="LAB_reg.php"  onsubmit="return valueEmpty()">
 <h2><center> <marquee direction="right" style="background-color:"> Gamby General Hospital </marquee> </h2>   </center>  
<h2><center> <marquee direction="none" style="background-color:"> Labtarosits signup form </marquee> </h2>   </center>
 <div class="in">FIRST NAME:</div> <input type="text" name="first_name" placeholder="enter your first name here" class="input" id="first_name"/>
 <br>
 ...
 <div class="in"> age:</div><input type="number" name="age"  class="input" id="age"/> 
<br>  
...
<li>
 ...
 <div class="in"> ADDRESS:</div>
  ...
  <li><div class="in">phone number:</div> <input type="number" name="phone_number"  placeholder="+251 - - - - - - - - -"  class="input"/></li>
   ...
   <li><div class="in">Email address:</div><input type="email" name="email_address" placeholder="someone@gmail.COM" class="input" id="email_address"/></li>
   <br>   <div class="in"> PASSWORD:</div><input type="password" name="password"  class="input"/>
