...
<form method="post" name="myform" action="recept_reg.php" onsubmit="return valueEmpty()" >
 <h2><center> <marquee direction="right" style="background-color:"> Gamby General Hospital </marquee> </h2>   </center>  
<h2><center> <marquee direction="none" style="background-color:"> Receptionists signup form </marquee> </h2>   </center>
