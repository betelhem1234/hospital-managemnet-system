...
-->
 ...
 <li  type="none"  ><a href="#">Log In</a>
  <ul>
           <li><a href="doclog.php">doctor</a></li>
           <li><a href="patientlog.php">patient</a></li>
		   <li><a href="receptionlog.php">reception</a></li>
		   <li><a href="lablog.php">labratorist</a></li>
		   <li><a href="pharmacylog.php">pharmasist</a></li>
...
<div class="middle";>
<p>
<h2>10+ years of digital experience</h2> <br><h3>Gamby General Hospital</h3>


We’re an award-winning digital agency committed to 
delivering uncompromising <br>customer service and real results for 
clients across the bahirdar and<br> around our country ethiopia.
We love a good challenge.<br>
Our team of specialists can handle any digital project or challenge thrown our way, and we mean it. <br>From high-performance websites to mobile apps and integrated marketing campaigns, <br>our work is beautiful, functional, and always focused on meeting your goals.

At DBS, we believe in partnerships and collaboration, pure and simple. Your goals become our goals. Your frustrations become our opportunities. Together, we get results.
 </p>
 </div>
<footer>
