...
<title> Delete labratorist</title>
...
$email = $_POST['email'];
	...
	if (!$connection) {
		...
		$sql = "select email_address from reception where email_address = '$email'";
			...
			echo "</script>";}
			 ...
			 $sqldelete = "delete from reception where email_address = '$email'";
