...
<div class="middle";>
<h2><center> <marquee direction="left" style="background-color:"> Results from Labratorist</marquee> </h2>   </center>  
...
<?php
        ...
        if (!$connection) {
          print("Server not found!!!");
            ...
            $sqlCheck = "SELECT patient_name,ultrasound,stool,urine,saliva FROM lab_response";
