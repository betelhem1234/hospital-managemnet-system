    ...
    echo "Only letters and white space allowed";
        ...
        if (!$connection) {
          print("Server not found!!!");
            ...
            $sqlCheck = "SELECT email_address FROM reception where email_address = '$email_address'";
            ...
            if (mysqli_num_rows($queryCheck)>0) {//if the user already registered
                ...
                print("<br><a href='receptionlog.php'>Goto reception login page</a>");
              }
              else {
                $sql = "INSERT INTO  reception  VALUES('$first_name','$middle_name','$last_name','$age','$gender','$phone_number','$email_address','$password')";
